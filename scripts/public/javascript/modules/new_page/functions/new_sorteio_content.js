    ...
    'sorteio de numeros': function() {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (Number(valor_2.value) > Number(valor_1.value)) {
                ...
                document.getElementById('calculate_button').focus()
                const a = document.querySelector('.data-box .header h1').textContent.toLowerCase()
                const b = document.querySelector('#calc_option_mover .option.on').textContent.toLowerCase()
